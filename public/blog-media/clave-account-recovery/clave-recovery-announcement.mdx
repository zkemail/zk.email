# Clave Releases ZKEmail Recovery Feature

![ZKEmail and Clave logos side by side with 'x' between them on a dark gradient background](zkemail-clave-collab.png)
...
![Recovery Process showing 10 steps from opening the app to completing recovery after 48 hours](recovery-process.png)
