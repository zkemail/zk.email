...
![ZKEmail and Clave logos side by side with 'x' between them on a dark gradient background](cover.png)
...
![Recovery Process showing 10 steps from opening the app to completing recovery after 48 hours](recovery.png)
